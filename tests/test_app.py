...
@pytest.mark.parametrize(
    ...
    [
        ("Unknown Activity", "student@mergington.edu", 404, "Activity not found"),
        ("Gym Class", "not-enrolled@mergington.edu", 404, "Student is not signed up for this activity"),
    ],
)
def test_unregister_validation_errors(client, activity_name, email, expected_status, expected_detail):
    # Arrange
